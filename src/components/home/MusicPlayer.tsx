  ...
  return (
    ...
    >
      ...
      <div className="z-10 mb-4 flex flex-1 items-center gap-4 rounded-xl border-4 border-black bg-white p-4 shadow-[4px_4px_0px_rgba(0,0,0,1)]">
        ...
        >
          <div className="h-5 w-5 rounded-full border-2 border-black bg-[#E6A627]"></div>
        </div>
      ...
      <div className="relative z-10 rounded-xl border-4 border-black bg-black p-3 text-[#F4F4F5]">
        ...
        <div className="flex items-center justify-center gap-6">
          ...
          <button
            ...
            className="flex h-10 w-10 items-center justify-center rounded-full border-2 border-black bg-[#E6A627] text-black shadow-[2px_2px_0px_rgba(255,255,255,1)] transition-transform hover:scale-110"

...
const getWeatherIcon = (code: number, isDay: boolean) => {
  if (code === 0 || code === 1) {
    return isDay ? <Sun className="w-8 h-8 text-[#C4A1FF] drop-shadow-[2px_2px_0px_rgba(0,0,0,1)]" /> : <Moon className="w-8 h-8 text-blue-400 drop-shadow-[2px_2px_0px_rgba(0,0,0,1)]" />;
  }
  if (code === 2 || code === 3) {
...
function LocationSkeleton() {
  return (
    <div className="h-full flex flex-col md:flex-row bg-white border-4 border-black rounded-xl shadow-[6px_6px_0px_rgba(0,0,0,1)] overflow-hidden animate-pulse">
      ...
      <div className="w-full md:w-[40%] bg-[#C4A1FF] p-5 flex flex-col justify-center items-center gap-4">
        ...
        <div className="w-full h-[60%] bg-[#F4F4F5] p-3.5 flex flex-col justify-between border-b-4 border-black relative">
          ...
          <div className="z-10 flex justify-between items-start">
            ...
            <a
              ...
              className="inline-flex items-center justify-center p-2 bg-black text-white hover:bg-[#C4A1FF] hover:text-black border-2 border-transparent hover:border-black rounded shadow-[2px_2px_0px_rgba(100,100,100,1)] hover:shadow-[2px_2px_0px_rgba(0,0,0,1)] transition-all"
